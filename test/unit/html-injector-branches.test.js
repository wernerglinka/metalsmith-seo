...
describe('HTML Injector Branch Coverage Tests', () => {
  beforeEach(() => {
    process.env.NODE_ENV = 'test';
  });

  describe('injectIntoHead branches', () => {
    it('should handle HTML without html element when creating head', () => {
    ...
    it('should handle HTML with html element when creating head', () => {
    ...
    it('should handle HTML without head when createHead is false', () => {
    ...
    it('should create title when ensureTitle is true and no title exists', () => {
    ...
    it('should not create title when ensureTitle is false', () => {
      const html = '<head></head><body>Content</body>';
      const result = injectIntoHead(html, '<meta name="test" content="value">', {
        ensureTitle: false
      });
    ...
    it('should handle all injection positions', () => {
    ...
    it('should handle before-title position when no title exists', () => {
    ...
    it('should handle after-title position when no title exists', () => {
      const html = '<head><meta name="existing" content="test"></head>';
      const content = '<meta name="test" content="value">';
    ...
    it('should handle invalid position as default end', () => {
      const html = '<head><meta name="existing" content="test"></head>';
      const content = '<meta name="test" content="value">';
  ...
  describe('updateTitle branches', () => {
    it('should create head when none exists', () => {
      const html = '<body>Content</body>';
    ...
    it('should create title when head exists but no title', () => {
  ...
  describe('updateMetaTag branches', () => {
    it('should create head when none exists', () => {
      const html = '<body>Content</body>';
    ...
    it('should insert after existing meta tags when no title', () => {
    ...
    it('should insert after title when no meta tags exist', () => {
    ...
    it('should prepend when no title or meta tags exist', () => {
    ...
    it('should handle HTML characters in meta tag attributes', () => {
      const html = '<head></head>';
  ...
  describe('updateLinkTag branches', () => {
    it('should create head when none exists', () => {
      const html = '<body>Content</body>';
    ...
    it('should replace existing link tag with same rel', () => {
    ...
    it('should handle empty additional attributes', () => {
      const html = '<head></head>';
      const result = updateLinkTag(html, 'canonical', 'https://example.com', {});
    ...
    it('should insert after existing link tags', () => {
    ...
    it('should insert after meta tags when no links exist', () => {
    ...
    it('should append when no meta or link tags exist', () => {
      const html = '<head><title>Test</title></head>';
      const result = updateLinkTag(html, 'canonical', 'https://example.com');

      assert(
        result.includes('</title><link rel="canonical"') ||
          (result.includes('</head>') && result.indexOf('<link') < result.indexOf('</head>')),
        'Should append to head'
      );
    });

    it('should handle HTML characters in link attributes', () => {
      const html = '<head></head>';
  ...
  describe('addScript branches', () => {
    ...
    it('should handle custom script type', () => {
      const html = '<head></head>';
    ...
    it('should handle end position (default)', () => {
      const html = '<head><meta name="test" content="value"></head>';
    ...
    it('should escape script type but not content', () => {
      const html = '<head></head>';
  ...
  describe('removeExistingMetaTags branches', () => {
    it('should remove default SEO meta tags when no custom tags specified', () => {
      const html = `
        <head>
    ...
    it('should remove only specified tags when custom tags provided', () => {
      const html = `
        <head>
    ...
    it('should handle tags with both name and property attributes', () => {
      const html = `
        <head>
    ...
    it('should handle empty tags array by using defaults', () => {
      const html = `
        <head>
          <meta name="description" content="old">
          <meta property="og:title" content="old">
  ...
  describe('Additional branch coverage tests', () => {
    it('should handle updateMetaTag with different insertion scenarios', () => {
    ...
    it('should handle updateLinkTag with various insertion positions', () => {
    ...
    it('should handle escapeHtml with null and undefined values', () => {
    ...
    it('should handle removeExistingMetaTags with specific tag list', () => {
    ...
    it('should handle addScript with position start vs end', () => {
    ...
    it('should handle updateLinkTag with attributes object edge cases', () => {
      // Test empty vs populated attributes
      const html = '<head></head>';

      const emptyAttrsResult = updateLinkTag(html, 'canonical', 'https://example.com', {});
      assert(
        emptyAttrsResult.includes('<link rel="canonical" href="https://example.com">'),
        'Should handle empty attributes object'
      );
    ...
    it('should handle HTML structures without html element in injectIntoHead', () => {
    ...
    it('should handle ensureTitle false with various positions', () => {
