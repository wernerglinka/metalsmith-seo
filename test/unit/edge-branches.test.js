...
describe('Edge Branch Coverage Tests', () => {
  beforeEach(() => {
    process.env.NODE_ENV = 'test';
  });

  describe('HTML injection edge cases', () => {
      ...
      Metalsmith('test/fixtures/hostname')
        ...
        .use((files, _metalsmith, done) => {
          ...
          files['with-title.html'] = {
            contents: Buffer.from(
              '<html><head><title>Existing Title</title><meta name="existing" content="true"></head><body>Content</body></html>'
            ),
            title: 'New Title',
          ...
          files['no-title.html'] = {
            contents: Buffer.from(
              '<html><head><meta name="existing" content="true"></head><body>Content</body></html>'
            ),
  ...
  describe('Meta generator edge cases', () => {
  ...
  describe('Generator combinations and fallbacks', () => {
      ...
      Metalsmith('test/fixtures/hostname')
        ...
        .use((files, _metalsmith, done) => {
          ...
          files['social-comprehensive.html'] = {
            contents: Buffer.from(
              '<html><head><title>Social Comprehensive</title></head><body>Article content</body></html>'
            ),
