...
import { generateOpenGraphTags, openGraphTagsToHtml } from '../../src/generators/opengraph-generator.js';

describe('OpenGraph Generator Branch Coverage Tests', () => {
  beforeEach(() => {
    process.env.NODE_ENV = 'test';
  });

  describe('generateOpenGraphTags branches', () => {
    it('should handle metadata without title', () => {
      ...
      assert(
        result.metaTags.find((tag) => tag.property === 'og:type'),
        'Should have og:type tag'
      );
    });
    ...
    it('should handle metadata without image', () => {
      const metadata = {
        title: 'Test Title',
        type: 'article'
      };
    ...
    it('should handle site config without siteName', () => {
      const metadata = {
        title: 'Test Title',
        type: 'article'
      };
    ...
    it('should handle locale preferences in site config', () => {
    ...
    it('should handle image metadata with custom dimensions', () => {
      const metadata = {
        title: 'Test',
        image: '/test.jpg',
    ...
    it('should handle image metadata with defaults', () => {
      const metadata = {
        title: 'Test Title',
        image: '/test.jpg'
        // No imageAlt
    ...
    it('should handle image type detection for all supported formats', () => {
      const formats = [
    ...
    it('should handle article-specific tags with all metadata', () => {
      const metadata = {
        title: 'Article Title',
        type: 'article',
      ...
      assert(
        result.metaTags.find((tag) => tag.property === 'article:published_time'),
        'Should have published time'
      );
      assert(
        result.metaTags.find((tag) => tag.property === 'article:modified_time'),
        'Should have modified time'
      );
      assert(
        result.metaTags.find((tag) => tag.property === 'article:author'),
        'Should have author'
      );
      assert(
        result.metaTags.find((tag) => tag.property === 'article:section'),
        'Should have section'
      );
      assert(
        result.metaTags.find((tag) => tag.property === 'article:reading_time'),
      ...
      assert(
        articleTags.some((tag) => tag.content === 'tech'),
        'Should have tech tag'
      );
      assert(
        articleTags.some((tag) => tag.content === 'article'),
        'Should have article tag'
      );
      assert(
        articleTags.some((tag) => tag.content === 'seo'),
        'Should have seo tag'
      );
    });

    it('should handle article-specific tags with missing metadata', () => {
      const metadata = {
        title: 'Article Title',
        type: 'article'
      ...
      assert(
        !result.metaTags.find((tag) => tag.property === 'article:published_time'),
        'Should not have published time'
      );
    ...
    it('should handle empty keywords array for articles', () => {
      const metadata = {
        title: 'Article Title',
        type: 'article',
        keywords: []
    ...
    it('should handle product-specific tags with all metadata', () => {
      const metadata = {
        title: 'Product Title',
        type: 'product',
        brand: 'Test Brand',
    ...
    it('should handle product-specific tags with missing metadata', () => {
      const metadata = {
        title: 'Product Title',
        type: 'product'
    ...
    it('should handle profile-specific tags with all metadata', () => {
      const metadata = {
        title: 'Profile Title',
        type: 'profile',
        firstName: 'John',
    ...
    it('should handle profile-specific tags with missing metadata', () => {
      const metadata = {
        title: 'Profile Title',
        type: 'profile'
    ...
    it('should handle Facebook app ID and admins', () => {
      const siteConfig = {
      ...
      assert(
        adminTags.some((tag) => tag.content === 'admin1'),
        'Should have admin1'
      );
      assert(
        adminTags.some((tag) => tag.content === 'admin2'),
        'Should have admin2'
      );
    });

    it('should handle single Facebook admin', () => {
      const siteConfig = {
    ...
    it('should handle missing Facebook configuration', () => {
  ...
  describe('openGraphTagsToHtml branches', () => {
    it('should handle HTML escaping in OpenGraph tags', () => {
      const metaTags = [
        {
