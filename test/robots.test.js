...
describe('metalsmith-seo robots.txt functionality', () => {
  beforeEach(() => {
    // Reset cache before each test to ensure clean state
  });

  it('should generate robots.txt when none exists', (_t, done) => {
  ...
  it('should not modify robots.txt that already has sitemap reference', (_t, done) => {
  ...
  it('should support custom robots.txt configuration', (_t, done) => {
    Metalsmith('test/fixtures/html')
      .use(
        seo({
          hostname: 'https://example.com',
  ...
  it('should coordinate with custom sitemap filename', (_t, done) => {
    Metalsmith('test/fixtures/html')
      .use(
        seo({
          hostname: 'https://example.com',
      ...
      .build((err, files) => {
        ...
        assert(
          robotsContent.includes('Sitemap: https://example.com/my-sitemap.xml'),
          'Should reference custom sitemap filename'
        );
